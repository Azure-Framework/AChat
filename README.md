...
Use `Az-Framework/modules/chat` through the main `Az-Framework` resource instead of installing this repository as a separate FiveM resource.

## Migration

1. Remove `ensure AChat` from `server.cfg`.
